...
ALTER TABLE Voto
CHANGE idEleitor fk_idEleitor INT,
CHANGE idCandidato fk_idCandidato INT;

ALTER TABLE Voto
ADD CONSTRAINT fk_para_idEleitor
FOREIGN KEY (fk_idEleitor)
REFERENCES Eleitor(idEleitor),
ADD CONSTRAINT fk_para_idCandidato
FOREIGN KEY (fk_idCandidato)
REFERENCES Candidato(idNumero_Candidato)
ON UPDATE CASCADE
ON DELETE CASCADE;


ALTER TABLE Eleitor
ADD CONSTRAINT fk_idNumero_do_Candidato
FOREIGN KEY (fk_idNumero_Candidato)
REFERENCES Candidato(idNumero_Candidato)
ON UPDATE CASCADE
ON DELETE CASCADE;
