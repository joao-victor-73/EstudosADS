...
-- Fazendo uma verificação de quantos funcionarios Masculinos e femininos tem:
SELECT sexo, COUNT(*) AS 'Quant.' FROM funcionarios
GROUP BY sexo;
...
-- SABER QUANTOS FUNCIONÁRIOS TEM EM CADA DEPARTAMENTO
SELECT COUNT(*), departamento FROM funcionarios
GROUP BY departamento;

--Traga os funcionarios que trabalhe no departamento de filmes OU no departamento de roupas;
SELECT idFuncionario, nome, departamento, cargo FROM funcionarios
WHERE departamento = 'Roupas'
OR departamento = 'Filmes';


/* O gestor de markting pediu a lista das funcionárias que trabalhem no departamento de filmes 
...
-- Vendo quantos funcionários existem no departamento 'Jardim'.
...
-- Esse aqui seria caso quisesse apenas os masculinos;
SELECT idFuncionario, nome, departamento, cargo, sexo FROM funcionarios
WHERE ( sexo = 'Masculino' )
OR ( departamento = 'Jardim' AND sexo = 'Masculino') -- Caso queira os func. femininos de jardim, é só apagar a clausula AND
